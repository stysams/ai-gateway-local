...
describe("validateProvider", () => {
  it("accepts a complete provider", () => {
    expect(validateProvider({ id: "openai-main", name: "OpenAI", adapter: "openai-responses", base_url: "https://api.openai.com/v1", extra_headers: [], default_model: "gpt-5", models: [{ id: "gpt-5", name: "GPT-5", context_window: 400000, max_output_tokens: 128000 }], api_key: "" })).toEqual({});
  });

  it("reports each invalid field", () => {
    const errors = validateProvider({ id: "Bad ID", name: "", adapter: "other", base_url: "file:///tmp", extra_headers: [], default_model: "", models: [], api_key: "" });
  ...
  it("validates model metadata and the default model reference", () => {
    const errors = validateProvider({ id: "openrouter", name: "OpenRouter", adapter: "openai-chat", base_url: "https://openrouter.ai/api/v1", extra_headers: [], default_model: "missing", models: [{ id: "m", context_window: 1000, max_output_tokens: 2000 }, { id: "m", context_window: 0, max_output_tokens: 0 }], api_key: "" });

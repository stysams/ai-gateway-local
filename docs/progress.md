...
> 当前源码主线：`d086d32f38f11f881dba99e8bb28bb72eb419c7a`
> 发布包：`dist/ai-gateway-0.1.0-rc1-windows-amd64.zip`，SHA-256 `D7AB92FF8BDE781DBA47CB143BA28CE32D23CBA392AF30894CC727DC86562AAF`
> 第一验收平台：Windows 11
...
这些不是新的任务包。它们已经在当前源码主线实现；截至包内构建提交 `74083c1` 的能力进入现有 `0.1.0-rc1` 包，包之后的源码变更仍在本文开头单独记录，不视为已进入现有包：
...
`0.1.0-rc1` 是当前唯一版本基准。现有发布包的版本、包内构建提交和 SHA-256 以本文开头记录为准；当前源码主线包含后续源码和文档变更，但不因此自动生成新版本。
...
源码主线：`d086d32f38f11f881dba99e8bb28bb72eb419c7a`

包内提交：`74083c13630675037172eb3b936df7f30808d777`
SHA-256：`D7AB92FF8BDE781DBA47CB143BA28CE32D23CBA392AF30894CC727DC86562AAF`

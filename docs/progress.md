...
> 文档日期：2026-08-23
> 包构建提交：`74083c13630675037172eb3b936df7f30808d777`（日志隐私治理、三协议能力扩展，以及按钮布局与滚动条尺寸优化；后续仅发布记录文档变更不影响包内容）
> 当前发布：`0.1.0-rc1`（`dist/ai-gateway-0.1.0-rc1-windows-amd64.zip`，SHA-256 `1BF5110275F3A9B281DC2F690064E2E839F6E5ABEDEE68065DB499C0F3C777E9`）
> 第一验收平台：Windows 11

...
> 状态：发布候选，第一期尚未验收完成  
> 文档日期：2026-08-17
> 当前提交：`76d0342136a63fe6f0dd74bcce137a1fb0a5b474`（发布包内二进制提交）
> 当前发布：`0.1.0-rc1`（`dist/ai-gateway-0.1.0-rc1-windows-amd64.zip`，SHA-256 `A2DDA5EA6D4E52BA855C7F265147C700E9365CC550836B0CDCE83E245F8F8B38`）
> 第一验收平台：Windows 11

...
> 文档日期：2026-08-23
> 包构建提交：`e4a4a8ef36811f9a9c63b2219c81190d955d2f2b`（日志隐私治理、三协议能力扩展、按钮布局与滚动条尺寸优化，以及路由控件对齐和模型字号优化；后续仅发布记录文档变更不影响包内容）
> 当前发布：`0.1.0-rc1`（`dist/ai-gateway-0.1.0-rc1-windows-amd64.zip`，SHA-256 `D7AB92FF8BDE781DBA47CB143BA28CE32D23CBA392AF30894CC727DC86562AAF`）
> 第一验收平台：Windows 11

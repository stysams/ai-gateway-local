...
> 文档日期：2026-08-22
> 当前提交：`ffb194ebdf9a4351c21678ceaeff3765a3b6c5f8`（发布包内二进制提交）
> 当前发布：`0.1.0-rc1`（`dist/ai-gateway-0.1.0-rc1-windows-amd64.zip`，SHA-256 `D6366B47228C93F47C251BA2F434F7E0A4BD7E56A2FE6FAC0BEAB81993E9E012`）
> 第一验收平台：Windows 11
...
2. `SEC-01` 已完成：管理 API 只接受真实 TCP 回环来源；后续按依赖启动 `RES-01`、`PERF-01`、`LOG-01`、`OBS-01`。
...
提交：`ffb194ebdf9a4351c21678ceaeff3765a3b6c5f8`
SHA-256：`D6366B47228C93F47C251BA2F434F7E0A4BD7E56A2FE6FAC0BEAB81993E9E012`
...
> 阅读 `docs/progress.md`、`docs/optimization-roadmap.md` 和 `docs/v1-scheme.md`。第一期已经带遗留问题验收，`G0-02` 和 `SEC-01` 已完成；默认按依赖启动 `RES-01`，并继续 `PERF-01`、`LOG-01`、`OBS-01`。第 13 节遗留问题不阻塞主线，除非用户明确要求处理。不要升级 Wails，不要改变冻结协议来换取测试通过。

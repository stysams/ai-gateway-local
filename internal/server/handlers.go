...
func (s *Server) routes() *http.ServeMux {
	...
	mux.HandleFunc("GET /api/v1/logs/{request_id}", s.handleLogDetail)
	mux.HandleFunc("GET /api/v1/usage", s.handleUsage)
	mux.HandleFunc("PUT /api/v1/logging", s.handleLogging)
	mux.HandleFunc("PUT /api/v1/autostart", s.handleAutostart)
